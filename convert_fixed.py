...
def run(ckpt_path, output_path):
    ...
    # Check for missing state_dict in the checkpoint model
    if "state_dict" not in ckpt:
        print("Missing 'state_dict' in the checkpoint. Adding an empty state_dict.")
        ckpt["state_dict"] = {}
    else:
        print("'state_dict' exists in the checkpoint. No changes needed.")
