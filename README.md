...
pip install torch typing_extensions numpy Pillow requests pytorch_lightning absl-py && pip install torch safetensors && apt-get install google-perftools && apt install libgoogle-perftools-dev
